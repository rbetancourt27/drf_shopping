...
def test_valid_shopping_list_is_created(api_client):
...
def test_shopping_list_name_missing_returns_bad_request(api_client):
    url = reverse("all-shopping-lists")
...
@pytest.mark.django_db
def test_all_shopping_lists_are_listed(api_client, shopping_list):
    url = reverse("all-shopping-lists")
    shopping_list(name="Groceries")
    shopping_list(name="Books")
...
@pytest.mark.django_db
def test_shopping_list_is_retrieved_by_id(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_shopping_list_name_is_changed(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_shopping_list_not_changed_because_name_missing(api_client, shopping_list):
...
@pytest.mark.django_db
def test_shopping_list_name_is_changed_with_partial_update(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_partial_update_with_missing_name_has_no_impact(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_shopping_list_is_deleted(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_valid_shopping_item_is_created(api_client, shopping_list):
    shopping_list = shopping_list(name="Groceries")
...
@pytest.mark.django_db
def test_shopping_item_is_retrieved_by_id(api_client, shopping_item):
    shopping_item = shopping_item(name="Chocolate")
...
@pytest.mark.django_db
def test_change_shopping_item_purchased_status(api_client, shopping_item):
    shopping_item = shopping_item(name="Chocolate")
...
@pytest.mark.django_db
def test_change_shopping_item_purchased_status_with_missing_data(
    api_client, shopping_item
):
    shopping_item = shopping_item(name="Chocolate")
...
@pytest.mark.django_db
def test_shopping_item_is_deleted(api_client, shopping_item):
    shopping_item = shopping_item(name="Chocolate")
